...
const nmServices = require('./app/nm/nm.service')
const verifyServices = require('./app/verify/service')
const codexServices = require('./app/codex/codex.service')
const ucodexService = require('./app/ucodex/ucodex.service')
...
require('./app/utils').createDbFolder()
